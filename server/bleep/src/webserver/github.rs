...
async fn get_access_token(code: &str) -> Result<String, Error> {
    ...
    params.insert("client_id", "3100477cd34818520ed1");
    params.insert("client_secret", "c855f3c21afc9b2438536baea1e34932175660f9");
    params.insert("code", code);
    params.insert("redirect_uri", "https://1987-2408-8459-3060-69d0-956d-1f47-c630-b4ba.ngrok-free.app/api/auth/callback" );
